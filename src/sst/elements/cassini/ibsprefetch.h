...
#ifndef _H_SST_IBS_PREFETCH
#define _H_SST_IBS_PREFETCH
...
class IBSPrefetcher : public SST::MemHierarchy::CacheListener
{
public:
    IBSPrefetcher(ComponentId_t id, Params& params);
    ~IBSPrefetcher();
...
private:
    void     DispatchRequest(Addr targetAddress, Addr ip);

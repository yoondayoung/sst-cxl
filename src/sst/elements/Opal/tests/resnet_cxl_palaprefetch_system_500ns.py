...
ariel.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "500ms"})
...
mmu.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "500ms"})
...
opal.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "500ms"})
...
l3_params = {
    ...
    #    "drop_prefetch_mshr_level" : "100",
        # "num_cache_slices" : 1,
      	# "slice_allocation_policy" : "rr",
       "prefetcher" : "cassini.PalaPrefetcher",
    #    "prefetcher" : "cassini.NextBlockPrefetcher",
       "prefetcher.reach": "2", # 4 -> 16 -> 32
       "prefetcher.detect_range": "8",
       "prefetcher.history": "16",
       "prefetcher.address_count": "128",
    #    "prefetcher.overrun_page_boundaries" : "1",
}
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_ResCXLPalaPrefetch_2_8_16_128_MemorySystemOutput4096.csv", "separator" : ", " } )
...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "executable" : "./app/vgg16_inf",
    "node" : 0,
    "tracer.trace_prefix" : "vgg16_cxl_10ns",
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_VGGCXLMemorySystemOutput4096TracePC10ns.csv", "separator" : ", " } )
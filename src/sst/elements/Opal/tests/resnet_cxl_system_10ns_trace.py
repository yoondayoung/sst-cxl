...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "node" : 0,
    "tracer.trace_prefix" : "resnet_cxl_10ns_100ms",
...
ext_dcLink.connect( (ext_dc_cpulink, "port", "10ns"), (internal_network.rtr, "port%d"%port, "10ns") )

sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_ResCXLMemorySystemOutput4096TracePC_final10ns100ms.csv", "separator" : ", " } )
...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "executable" : "./app/resnet_inf",
    "tracer.trace_prefix" : "resnet_cxl_prefetch",
    "tracegen" : "ariel.TextTraceGenerator",
    "node" : 0,
    "launchparamcount" : 1,
...
for next_core in range(cores):
        ...
        l2.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1s"})
...
ext_dcLink.connect( (ext_dc_cpulink, "port", "1000ps"), (internal_network.rtr, "port%d"%port, "200ns") )

sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./resnet_results_csv/ResCXLPrefetchMemorySystemOutput.csv", "separator" : ", " } )
...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "node" : 0,
    "tracer.trace_prefix" : "resnet_cxl_500ns",
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_ResCXLMemorySystemOutput4096TracePC_final.csv", "separator" : ", " } )
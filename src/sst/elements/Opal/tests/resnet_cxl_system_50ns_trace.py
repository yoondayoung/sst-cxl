...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "node" : 0,
    "tracer.trace_prefix" : "resnet_cxl_50ns_100ms",
...
ext_dcLink.connect( (ext_dc_cpulink, "port", "50ns"), (internal_network.rtr, "port%d"%port, "50ns") )

sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_ResCXLMemorySystemOutput4096TracePC_final50ns100ms.csv", "separator" : ", " } )
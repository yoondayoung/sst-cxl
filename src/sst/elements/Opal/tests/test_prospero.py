...
ext_dcLink.connect( (ext_dc_cpulink, "port", "500ps"), (internal_network.rtr, "port%d"%port, "200ns") )

sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./testTrace.csv", "separator" : ", " } )
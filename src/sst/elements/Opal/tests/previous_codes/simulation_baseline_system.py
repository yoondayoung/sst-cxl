...
# external_network = Network("Ext_Mem_Net",1,"100ns","100ns")
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./test_results_csv/BaselineMemorySystemOutput.csv", "separator" : ", " } )
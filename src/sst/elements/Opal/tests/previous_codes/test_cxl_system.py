...
params = { "rate" : "1ms" } # Report statistics every 500ns

#sst.setStatisticOutput("sst.statOutputTXT", {"filepath" : "./test_results_csv/testCXLMemorySystemOutput2.txt", "separator" : ", ", "rate" : "500ns" } )
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./test_results_csv/testCXLMemorySystemOutput2.csv", "separator" : ", " } )
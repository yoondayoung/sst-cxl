...
sst.setProgramOption("stopAtCycle", "5ms")
...
ariel.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1ms"})
...
mmu.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1ms"})
...
opal.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1ms"})
...
# sst.setStatisticRate(params)
#sst.setStatisticOutput("sst.statOutputTXT", {"filepath" : "./test_results_csv/testCXLMemorySystemOutput2.txt", "separator" : ", ", "rate" : "500ns" } )
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./test_results_csv/testCXLMemorySystemOutput22.csv"} )
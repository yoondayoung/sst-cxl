...
# external_network = Network("Ext_Mem_Net",1,"200ns","200ns")
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./test_results_csv/BaselineMemoryPrefetchSystemOutput.csv", "separator" : ", " } )
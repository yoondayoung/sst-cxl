...
#     "mallocmapfile" : "/home/ydy/scratch/src/sst-elements/src/sst/elements/Opal/tests/mallocmap.txt", #Should intercept ariel_malloc_flag() and interpret using a malloc map: specify filename or leave blank for disabled
    "appargcount" : 0,
#     "max_insts" : 10000,
    # "executable" : "./app/cpu_vgg16_inference_no_mlm",
    # "executable" : "./app/vgg16_inf",
...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "executable" : "./app/resnet_inf_no_mlm",
    "node" : 0,
    "launchparamcount" : 1,
...
ariel.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1s"})
...
mmu.addParams({
	...
	"latency_PTWC": 4, # This is the latency of checking the page table walk cache
	"opal_latency": "0ps",
	"emulate_faults": 1,
})
...
mmu.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1s"})
...
opal.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1s"})
...
l3cache.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1s"})
...
mem.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1s"})
...
ext_dcLink.connect( (ext_dc_cpulink, "port", "500ps"), (internal_network.rtr, "port%d"%port, "500ps") )

ext_mem.enableAllStatistics({"type":"sst.AccumulatorStatistic", "rate": "1s"})

sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./test_results_csv/22Baseline2PrefetchMemorySystemOutput.csv", "separator" : ", " } )
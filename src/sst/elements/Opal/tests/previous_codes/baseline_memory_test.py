...
for next_core in range(cores):
        ...
        l2_memlink = l2.setSubComponent("memlink", "memHierarchy.MemNIC")
...
l3_link = l3cache.setSubComponent("cpulink", "memHierarchy.MemNIC")
...
dc_cpulink = dc.setSubComponent("cpulink", "memHierarchy.MemNIC")

...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./resnet_results_csv/4MB_ResCXLPrefetch_reach4_MemorySystemOutput500.csv", "separator" : ", " } )
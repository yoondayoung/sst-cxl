...
#     "mallocmapfile" : "/home/ydy/scratch/src/sst-elements/src/sst/elements/Opal/tests/mallocmap.txt", #Should intercept ariel_malloc_flag() and interpret using a malloc map: specify filename or leave blank for disabled
    "appargcount" : 0,
#     "max_insts" : 10000,
    "executable" : "./app/google_inf",
    "node" : 0,
    "tracer.trace_prefix" : "googlenet_cxl_10ns_100ms",
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_GoogleCXLMemorySystemOutput4096TracePC_10ns100ms.csv", "separator" : ", " } )
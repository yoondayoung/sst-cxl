...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "node" : 0,
    "tracer.trace_prefix" : "googlenet_cxl_50ns_100ms",
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_GoogleCXLMemorySystemOutput4096TracePC_500ns100ms.csv", "separator" : ", " } )
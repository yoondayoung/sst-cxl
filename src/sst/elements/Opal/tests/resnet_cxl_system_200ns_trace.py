...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "node" : 0,
    "tracer.trace_prefix" : "resnet_cxl_200ns_100ms",
...
ext_dcLink.connect( (ext_dc_cpulink, "port", "200ns"), (internal_network.rtr, "port%d"%port, "200ns") )

sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_ResCXLMemorySystemOutput4096TracePC_final200ns100ms.csv", "separator" : ", " } )
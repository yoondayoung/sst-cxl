...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    "executable" : "./app/resnet_short",
    "tracer.trace_prefix" : "resnet_debug",
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_debug/8MB_ResCXLMemorySystemOutput4096_22.csv", "separator" : ", " } )
...
#     "executable" : "./app/cpu-rnn-inference-int8-cpp",
    ...
    # "executable" : "./app/inference_test_no_mlm",
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./resnet_results_csv/ResBaseline2PrefetchMemorySystemOutput.csv", "separator" : ", " } )
...
l3_params = {
    ...
    #    "prefetcher.reach": "32", # 4 -> 16 -> 32
    #    "prefetcher.detect_range": "32",
    #    "prefetcher.history": "16",
    #    "prefetcher.address_count": "256",
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./csv_results/8MB_ResCXLPrefetch_original_MemorySystemOutput4096.csv", "separator" : ", " } )
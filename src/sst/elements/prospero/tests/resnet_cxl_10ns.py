...
comp_cpu.addParams({
    ...
    "readerParams.file" : "/home/ydy/sst-elements/sst-elements-src/src/sst/elements/Opal/tests/resnet_cxl_10ns_100ms-0.trace",
...
l3_params = {
    ...
    #    "max_outstanding_prefetch": 3000,
    #    "prefetcher" : "cassini.NextBlockPrefetcher",
        "prefetcher.prefetcher_mode" : 4,
        "prefetcher.prefetch_table_path": "/home/ydy/sst-elements/sst-elements-src/src/sst/elements/prospero/tests/prefetch_tables/prefetch_iplist_resnet_10ns_512kb.txt",
       "prefetcher.reach": 1,
       "prefetcher.detect_range": 1,
}
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./final_csv_results/512KB_Resnet_10ns100ms_500ns_ipinst.csv", "separator" : ", " } )
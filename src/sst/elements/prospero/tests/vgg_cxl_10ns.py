...
comp_cpu.addParams({
    ...
    "readerParams.file" : "/home/ydy/sst-elements/sst-elements-src/src/sst/elements/Opal/tests/vgg16_cxl_10ns-0.trace",
...
l3_params = {
    ...
    #    "prefetcher" : "cassini.NextBlockPrefetcher",
        "prefetcher.prefetcher_mode" : 4,
        "prefetcher.prefetch_table_path": "/home/ydy/sst-elements/sst-elements-src/src/sst/elements/prospero/tests/prefetch_tables/prefetch_iplist_vgg_10ns_512kb.txt",
       "prefetcher.reach": 1,
       "prefetcher.detect_range": 1,
}
...
netLink.connect((dc_cpulink, "port", "10ns"), (internal_network.rtr, "port%d"%(internal_network.getNextPort()), "10ns"))
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./final_csv_results/512KB_VGG_10ns100ms_500ns_ipinst.csv", "separator" : ", " } )
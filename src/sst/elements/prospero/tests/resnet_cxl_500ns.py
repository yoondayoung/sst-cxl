...
comp_cpu.addParams({
    ...
    "readerParams.file" : "/home/ydy/sst-elements/sst-elements-src/src/sst/elements/Opal/tests/resnet_cxl_500ns_100ms-0.trace",
...
l3_params = {
    ...
    #    "prefetcher" : "cassini.NextBlockPrefetcher",
        ...
        # "prefetcher.prefetch_table_path": "/home/ydy/sst-elements/sst-elements-src/src/sst/elements/prospero/tests/prefetch_tables/prefetch_iplist_resnet_500ns_512kb.txt",
       "prefetcher.reach": 1,
       "prefetcher.detect_range": 1,
}
...
sst.setStatisticOutput("sst.statOutputCSV", {"filepath" : "./final_csv_results/512KB_Resnet_500ns100ms_500ns_ibsp+nb.csv", "separator" : ", " } )